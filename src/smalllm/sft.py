...
from smalllm.optimizer import build_optimizer
from smalllm.tokenizer import load_frozen_tokenizer, optional_hf_token, tokenizer_sha256
...
def run_sft(
    ...
    *,
    ...
    if not any(device.platform == "gpu" for device in jax.devices()):
        raise RuntimeError("SmallLM SFT requires a JAX GPU runtime")
...
def main(argv: Sequence[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Run/resume SmallLM SFT")
