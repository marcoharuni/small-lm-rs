# mypy: ignore-errors
"""Exact Flax NNX SmallLM-8M-SiTU training model."""
...
from smalllm.config import MODEL, ModelConfig
...
def initialize_model(seed: int, config: ModelConfig = MODEL):
    """Construct SmallLM and return its NNX graph definition and parameter state."""

    model = SmallLM(config, rngs=nnx.Rngs(params=seed))
