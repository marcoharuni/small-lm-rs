# mypy: ignore-errors
"""Deterministic FineWeb-Edu validation for a trained SmallLM checkpoint."""
...
from smalllm.config import checkpoint_dir, load_profile, run_dir, workspace_root
from smalllm.data import TokenBatcher
from smalllm.model import initialize_model
from smalllm.pretrain import require_gpu, verify_profile_data
from smalllm.trainer import compile_evaluation_step, evaluate
...
def main(argv: Sequence[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Evaluate a trained SmallLM checkpoint")
