"""Unified command line for preparing, training, evaluating, and exporting SmallLM."""
...
def _doctor() -> None:
    from smalllm.tokenizer import load_tokenizer, validate_tokenizer
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="smalllm", description="SmallLM training toolkit")
...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.command == "evaluate":
        from smalllm.evaluate import evaluate_checkpoint
