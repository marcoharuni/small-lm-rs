...
from nilemini.tokenizer import fineweb_documents, tokenizer_sha256
...
def main(argv=None) -> None:
    ...
    from nilemini.config import load_profile, workspace_root
    from nilemini.tokenizer import ensure_tokenizer, load_frozen_tokenizer

    parser = argparse.ArgumentParser(description="Prepare NileMini FineWeb-Edu token files")
